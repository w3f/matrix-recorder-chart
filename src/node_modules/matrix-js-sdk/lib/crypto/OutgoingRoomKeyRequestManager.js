...
var OutgoingRoomKeyRequestManager = function () {
    function OutgoingRoomKeyRequestManager(baseApis, deviceId, cryptoStore) {
        _classCallCheck(this, OutgoingRoomKeyRequestManager);
    ...
    _createClass(OutgoingRoomKeyRequestManager, [{
        key: 'start',
                ...
                switch (req.state) {
                    ...
                    case ROOM_KEY_REQUEST_STATES.SENT:
                        ...
                        return _this2._cryptoStore.updateOutgoingRoomKeyRequest(req.requestId, ROOM_KEY_REQUEST_STATES.SENT, {
                            ...
                            // do.)
                            _this2._sendOutgoingRoomKeyRequestCancellation(updatedReq).catch(function (e) {
        ...
        value: function _sendOutgoingRoomKeyRequests() {
            ...
            return this._cryptoStore.getOutgoingRoomKeyRequestByState([ROOM_KEY_REQUEST_STATES.CANCELLATION_PENDING, ROOM_KEY_REQUEST_STATES.UNSENT]).then(function (req) {
                if (!req) {
        ...
        value: function _sendOutgoingRoomKeyRequestCancellation(req) {
            var _this6 = this;
